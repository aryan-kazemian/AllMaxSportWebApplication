    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('manager', 'Manager'), ('admin', 'Admin'), ('user', 'User')], default='user', max_length=10)),
                ...
                ('address_phone', models.CharField(blank=True, max_length=11, null=True)),
                ...
                ('average_order_value', models.FloatField(blank=True, null=True)),
